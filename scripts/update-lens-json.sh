...
# Script to encode doping-lens.js to base64 and update doping-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/doping-lens.js"
JSON_FILE="$PROJECT_DIR/doping-lens.json"
...
console.log('✅ Updated doping-lens.json with encoded JS');
"
